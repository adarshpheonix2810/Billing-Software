...
def setup_database(cursor):
    ...
    CREATE TABLE IF NOT EXISTS bill (
        bill_no TEXT NOT NULL PRIMARY KEY,
        date TEXT NOT NULL,
    ...
    ('EMP1000', 'Demo Admin', '9860534826', 'Nashik', '562486173954', 'admin01', 'Admin')
...
def connect_to_database():
    ...
    connection_string = "postgresql://neondb_owner:npg_MNlxuciR51ZS@ep-round-star-a8saecy2.eastus2.azure.neon.tech/BillingSoftwares?sslmode=require"
...
# Call the function to connect and setup the database
connect_to_database()
...
with psycopg2.connect("postgresql://neondb_owner:npg_MNlxuciR51ZS@ep-round-star-a8saecy2.eastus2.azure.neon.tech/BillingSoftwares?sslmode=require") as db:
    cur = db.cursor()
    ...
    def delete_product(self):
        ...
        if len(self.sel) != 0:
            ...
            if sure == True:
                ...
                for k in to_delete:
                    delete = "DELETE FROM raw_inventory WHERE product_id = %s"
                                    ...
                                    try:
                                        ...
                                        if valid_phone(pvendor):
                                            with psycopg2.connect("postgresql://neondb_owner:npg_MNlxuciR51ZS@ep-round-star-a8saecy2.eastus2.azure.neon.tech/BillingSoftwares?sslmode=require") as db:
                                                cur = db.cursor()
                                            insert = (
                                                        "INSERT INTO raw_inventory(product_name, product_cat, product_subcat, stock, mrp, cost_price, vendor_phn) VALUES(%s,%s,%s,%s,%s,%s,%s)"
                                                    )
                                    ...
                                    try:
                                        ...
                                        if valid_phone(pvendor):
                                            ...
                                            with psycopg2.connect("postgresql://neondb_owner:npg_MNlxuciR51ZS@ep-round-star-a8saecy2.eastus2.azure.neon.tech/BillingSoftwares?sslmode=require") as db:
                                                cur = db.cursor()
                                            update = (
                                            "UPDATE raw_inventory SET product_name = %s, product_cat = %s, product_subcat = %s, stock = %s, mrp = %s, cost_price = %s, vendor_phn = %s WHERE product_id = %s"
                                            )
                    ...
                    if edes:
                        if eadd:
                            if epass:
                                ...
                                insert = (
                                            "INSERT INTO employee(emp_id, name, contact_num, address, aadhar_num, password, designation) VALUES(%s,%s,%s,%s,%s,%s,%s)"
                                        )
    ...
    def delete_invoice(self):
        ...
        if len(self.sel)!=0:
            ...
            if sure == True:
                ...
                for k in to_delete:
                    delete = "DELETE FROM bill WHERE bill_no = %s"
                    cur.execute(delete, [k])
                    db.commit()
...
class open_bill:
    def __init__(self, top=None):
        ...
        find_bill = "SELECT * FROM bill WHERE bill_no = %s"
